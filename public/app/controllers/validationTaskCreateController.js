...
.controller('validationTaskCreateController', function ($location, $scope, $log, taskTemplateFactory, taskFactory, shootFactory, localStorage, $stateParams, Upload, $timeout) {

  // the initial state, used for reset
  var initialTask = {
    type: 'validation', // Type of task is an ADDITION task. The API will handle different types differently
    job_count: 50,
    meta_object: 'crowdsourced',
    meta_key: 'template_identified',
    meta_value: '{{templateId}}',
    name: 'validate template',
    description: 'Attempt to validate the video shoot template',
    ...
    instructions: 'Please watch the video from start to finish. You will be given FOUR templates to choose from. These templates describe how the video should have been framed and taken. Please select the template that BEST DESCRIBES the video. A description has been provided for each template.',
    cent_per_job: 5,
  };
